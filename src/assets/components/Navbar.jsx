...
const Navbar = () => {
  ...
  return (
    <nav ref={menuRef} className="bg-white dark:bg-black shadow-md-white fixed top-0 w-full z-10">
        ...
        <ul className={`hidden xl:flex space-x-6`}>
          ...
          <li className="relative text-center" title="Nos Médias">
            ...
            {openSection === "medias" && (
              <ul className="absolute bg-white shadow-md mt-2 p-3 rounded">
                <li>
                  <Link to="/films" className="hover:text-blue-500">
                    Films
                  </Link>
                </li>
                <li className="mt-2">
  ...
  <ul className="xl:hidden bg-gray-100 dark:bg-gray-900 absolute top-0 left-0 w-full shadow-md p-4 space-y-4">
    ...
    <li>
      ...
      {openSection === "medias" && (
        <ul className="mt-2 pl-4">
          <li>
            <Link to="/films" className="block text-blue-600 dark:text-white">
              Films
            </Link>
          </li>
          <li className="mt-2">
